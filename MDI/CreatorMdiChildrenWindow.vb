...
''' </summary>
MustInherit Class CreatorMdiChildrenWindow
    ''' <summary>
    ...
    ''' <returns></returns>
    Protected MustOverride Function CreateWindow(inMainForm As FrmMain) As IMdiChildrenWindow
    ...
    ''' </summary>
    ''' <returns></returns>      
    Public Function GetWindow(inMainForm As FrmMain) As IMdiChildrenWindow
        Return Me.CreateWindow(inMainForm)
    End Function
